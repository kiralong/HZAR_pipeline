...
snp_ID_file <- "test_line_281.tsv"

#This is the hzar file output by stacks
hzar_input_file <- "populations.hzar.csv"

##Read in data to R
## Also note that R is adding an 'X' to the beginning of each locus ID becuase they are numerical and it wants a letter there
...
#  a <- 230.75 # This is the position of pop10 in the Brumfield et al. 2001 paper.We adjusted accordingly
cg <- 00.00
pr <- 20.75
ru <- 29.50
qp <- 42.50
